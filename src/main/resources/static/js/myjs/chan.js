...
function page(pageIndex) {
    ...
    var states=$("#noticePuer").val();
    var data="pageIndex="+pageIndex+"&addTime="+addTime+
        "&states="+states;
    $.post("/sys/chans.html",data,function (relData) {
        var list = relData.dataList;
        var str="";
        for(var i=0;i<list.length;i++)
        {
            str+="<tr>\n" +
                "<th style=\"text-align: center; vertical-align: middle; \" data-field=\"ID\" tabindex=\"0\"><div class=\"th-inner \">"+list[i].chanName+"</div><div class=\"fht-cell\"></div></th>\n" +
                "<th style=\"text-align: center; vertical-align: middle; \" data-field=\"ID\" tabindex=\"0\"><div class=\"th-inner \" >"+list[i].source+"</div><div class=\"fht-cell\"></div></th>\n" +
